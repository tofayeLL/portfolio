...
<div className="grid  grid-cols-1 gap-10 px-4 py-20 rounded-lg md:grid-cols-2 " >
    ...
    <div className="flex pt-6 flex-col justify-between lg:px-6 space-y-5 text-slate-200 ">

        <div className="py-6 md:py-0 ">

            <h1 className="text-4xl font-bold">Get in touch</h1>
            <p className="pt-5 pb-6 lg:text-lg md:text-base text-xs">Fel free to send me message. Fill in the form to start a conversation with me.</p>
            ...
            <div className="space-y-4">
                ...
                <p className="flex items-center">
                    ...
                    <span className="lg:text-lg md:text-base text-xs"> Dhaka, Bangladesh </span>
                </p>
                <p className="flex items-center">
                    <span className="w-5 h-5 mr-2 sm:mr-4">
                        <IoMdCall className="text-xl"></IoMdCall>
                    </span>
                    <span className="lg:text-lg md:text-base text-xs">01795628299</span>
                </p>
                ...
                <p className="flex lg:flex-row items-center flex-wrap">
                    ...
                    <p className="lg:text-lg md:text-base text-xs">ahmedtofayel132@gmail.com</p>
    ...
    <form onSubmit={handleMessage} className="space-y-6 text-slate-300">
        <div>
            <label name="name" className="text-lg ">Full name</label>
            <input  id="name" type="text" placeholder="Your  name" className="w-full p-3 text-black rounded " required />
        </div>
        <div>
            <label name="email" className="text-lg">Email</label>
            <input id="email" type="email" className="w-full p-3 rounded text-black " placeholder='Your email' required />
        </div>
        <div>
            <label name="message" className="text-lg">Message</label>
            <textarea id="message" rows="3" className="w-full p-3 rounded text-black" placeholder='Message...' required></textarea>
        </div>
